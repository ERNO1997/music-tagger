...
In-browser playback of tracked audio files directly from the web UI, without requiring a separate media player or file download, across any of the library's views (table, grid, folder tree, Artist-Album).
