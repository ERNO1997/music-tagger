...
Resolving a track's plain and, when available, LRC-timed synced lyrics via LRCLIB — a free, unauthenticated lyrics API — given the track's resolved artist, title, album, and duration.
